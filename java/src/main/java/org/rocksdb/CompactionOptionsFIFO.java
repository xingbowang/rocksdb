...
public class CompactionOptionsFIFO extends RocksObject {
   ...
   * @return the reference to the current options.
   */
  public CompactionOptionsFIFO setMaxDataFilesSize(
      final long maxDataFilesSize) {
   ...
   * @return the reference to the current options.
   */
  public CompactionOptionsFIFO setUseKvRatioCompaction(
  ...
  private static native void setUseKvRatioCompaction(final long handle, final boolean useKvRatioCompaction);
