...
jlong Java_org_rocksdb_BlockBasedTableConfig_newTableFactoryHandle(
    ...
    jlong jsuper_block_alignment_space_overhead_ratio,
    jlong jpin_entire_sst_max_size, jbyte jindex_shortening,
  ...
  options.pin_entire_sst_max_size =
      static_cast<size_t>(jpin_entire_sst_max_size);
