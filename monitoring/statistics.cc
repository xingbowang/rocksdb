...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {BLOB_GC_CANDIDATES_FOUND, "rocksdb.blob.gc.candidates.found"},
    {BLOB_GC_FILES_COLLECTED, "rocksdb.blob.gc.files.collected"},
    {BLOB_GC_BYTES_RECLAIMED, "rocksdb.blob.gc.bytes.reclaimed"},
    {BLOB_GC_BYTES_RELOCATED, "rocksdb.blob.gc.bytes.relocated"},
