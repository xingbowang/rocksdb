...
class MemTable final : public ReadOnlyMemTable {
 public:
  ...
  // This method uses the optimized InsertBatch API for better performance.
  //
  ...
  //   - key
  //   - value
  //   - optional protection info
  //
  // REQUIRES: external synchronization (allow_concurrent not supported yet)
  // REQUIRES: all entries must be for the same table (not mixed with range
  // dels)
  //
  // Returns number of entries successfully inserted, or error status
